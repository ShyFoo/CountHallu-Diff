...
class ImagePathDataset(Dataset):
    def __init__(self, image_folder):
        ...
        # A custom torch.transforms function for inceptionv3 model
        ...
        self.image_paths = [f for ext in ('png', 'jpg', 'jpeg', 'bmp', 'tiff')
                            for f in glob.glob(f"{image_folder}/**/*.{ext}", recursive=True)]
